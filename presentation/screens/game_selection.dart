...
class _GameSelectionScreenState extends State<GameSelectionScreen>
  ...
  void _startGame() async {
    ...
    try {
      ...
      switch (_selectedGameIndex) {
        ...
        case 2: // 발음 연습
          AppLogger.event(
              '발음 연습 게임 시작: 난이도=$_selectedDifficulty, 문제수=$_selectedQuizCount');
                        ...
                        child: ListView(
                          children: [
                            ...
                            _buildGameCard(
                              index: 2,
                              title: '발음 연습',
                              description: '올바른 발음으로 단어를 말해보세요',
                              iconData: Icons.mic,
  ...
  Widget _buildDifficultyButton(
      String difficulty, Color color, StateSetter setSheetState) {
