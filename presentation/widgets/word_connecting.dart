...
class _WordConnectingGameWidgetState extends State<WordConnectingGameWidget> {
  ...
  void initState() {
    super.initState();
    // 초기 연결 상태 설정
    connectionPairs = widget.initialConnectionPairs ??
                        ...
                        (index) {
                          ...
                          return Padding(
                            ...
                            child: buildConnectionCard(
                              ...
                              isCorrectPair: _allConnected &&
                                  connectionPairs[index] != null &&
                                  widget.optionWords[index].word ==
                                      widget
                                          .optionWords[widget.rightIndices[
                                              connectionPairs[index]!]!]
                                          .word,
